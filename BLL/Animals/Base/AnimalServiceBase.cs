...
namespace BLL.Animals.Base
{
    ...
    {
        private readonly IAnimalRepositoryPort<TAnimal> _repository;
        ...
        protected AnimalServiceBase(IAnimalRepositoryPort<TAnimal> repository)
        {
